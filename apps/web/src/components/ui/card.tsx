...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "flex flex-col gap-1.5 p-[var(--space-card-padding)]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("p-[var(--space-card-padding)] pt-0", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "flex items-center gap-2 p-[var(--space-card-padding)] pt-0",
      className
    )}
    {...props}
  />
